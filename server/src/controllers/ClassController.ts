...
import convertHourToMinutes from "../utils/hoursToMinutes";
...
export default class ClassController {
  async listClasses(req: Request, res: Response) {
    ...
    if (!filters.week_day || !filters.course || !filters.time) {
  ...
  async create(req: Request, res: Response) {
    const { name, avatar, whatsapp, bio, course, cost, schedule } = req.body;
